...
export const menuItems: MenuItem[] = [
  ...
  { id: "vanilla-cone", name: "Vanilla Cone", category: "Konero In Cones", description: "A crisp cone with smooth, timeless vanilla.", price: 55, image: image("photo-1589710751893-f9a6770ad71b"), vegetarian: true },
